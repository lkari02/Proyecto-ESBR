...
const translations = {
  ...
  // NAVEGACIÓN Y FOOTER (Global)
    ...
    "feat_3_desc": "We manufacture parts according to your blueprints or sample, specifications, and choice of material, adapting to your equipment's exact needs.",
    "about_title": "Who We Are",
    "about_desc": "At Pumping Equipment, Service and Spare Parts, we are dedicated to manufacturing and supplying spare parts adapted to the specifications, blueprints, samples and materials each client requires, providing exact solutions for their equipment...",
    ...
    "mission_desc": "To manufacture and provide exact spare parts according to each client's blueprints or sample,  materials, and needs, ensuring precision machining and efficient response times.",
  ...
  // ------------------------------------
    ...
    "feat_3_desc": "Fabricamos piezas según sus planos o muestra, especificaciones y elección de material, adaptándonos a las exigencias exactas de su equipo.",
    "about_title": "Quiénes Somos",
    "about_desc": "En Equipos de Bombeo, Servicio y Refacciones, nos dedicamos a fabricar y suministrar refacciones adaptadas a las especificaciones, planos, muestras y materiales que cada cliente requiere, brindando soluciones exactas para sus equipos...",
    ...
    "mission_desc": "Fabricar y proveer refacciones exactas según los planos o muestras, materiales y necesidades de cada cliente, garantizando un maquinado de precisión y tiempos de respuesta eficientes.",
